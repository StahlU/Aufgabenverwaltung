...
//        mitarbeiterList.setAll(AufgabenGenerator.generiereListe(1000));
        ...
        mitarbeiterListView.setOnMouseClicked(this::handleMitarbeiterClick);
            ...
            mitarbeiterListView.setCellFactory(lv -> new ListCell<Mitarbeiter>() {
                ...
                private final Image iconEmpty = new Image(getClass().getResourceAsStream("/StahlU/aufgabenverwaltung/icons/icon_empty.png"));
                private final Image iconPartial = new Image(getClass().getResourceAsStream("/StahlU/aufgabenverwaltung/icons/icon_partial.png"));
                private final Image iconDone = new Image(getClass().getResourceAsStream("/StahlU/aufgabenverwaltung/icons/icon_done.png"));
